...
function openBook(project) {
  ...
  let data = {
    ...
    p2: "<h2>Title Project to come...</h2><p>Title Project to come...</p>",
    p3: `<h2>The Hidden Chapter</h2>
      ...
      <p>The website serves as a marketing and informational platform, highlighting the bookstore's offerings, store information, and community engagement, while following best practices in repository organization, version control, and documentation. View it here: <a href='https://msoto2027.github.io/the-hidden-chapter/' target='_blank' rel='noopener noreferrer'>The Hidden Chapter Website</a>.</p>`,
    ...
    p5: "<h2>Title Project to come...</h2><p>Title Project to come...</p>",
    p6: `<h2>Itinera</h2>
